package com.ssh.framework.servlet;
...
import com.ssh.framework.constant.BaseFinal;
...
public class VerifyCodeServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		int width=120;//验证码图片宽度 150
		int height=60;//验证码图片高度 60
		...
		session.setAttribute(BaseFinal.SESSION_VERIFYCODE, sRand); 
		g.dispose();//图像生效 
		//禁止图像缓存 
